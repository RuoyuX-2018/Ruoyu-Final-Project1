...
if __name__ == '__main__':
    ...
    #DCB_dir_HR = join(dataset_root, 'DCB_Depth/HR/')
    #DCB_dir_LR = join(dataset_root, 'DCB_Depth/LR/')
    DCB_dir_HR = join(dataset_root, 'DCB_Depth_multi/HR/')
    DCB_dir_LR = join(dataset_root, 'DCB_Depth_multi/LR/')
    ...
    #built = build(hparams, True, device, dataset['catIds'], load_path='assets/log_20221130_0344/checkpoints/')
